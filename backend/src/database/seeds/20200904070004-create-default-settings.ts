...
module.exports = {
  up: (queryInterface: QueryInterface) => {
    return queryInterface.sequelize.query(
      ...
      INSERT INTO public."Settings" ("key", value, "createdAt", "updatedAt", "tenantId", id) VALUES('userDisableSignature', 'disabled', '2020-12-12 16:08:45.354', '2020-12-12 16:08:45.354', 1, 11);
      INSERT INTO public."Settings" ("key", value, "createdAt", "updatedAt", "tenantId", id) VALUES('userContactWallet', 'disabled', '2020-12-12 16:08:45.354', '2020-12-12 16:08:45.354', 1, 12);
      `
    );
  },
