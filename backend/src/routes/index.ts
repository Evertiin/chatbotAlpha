...
import internalMessageRouter from "./internalMessageRouter";
import groupRoutes from "./groupRoutes";
import ultilizacaoRoutes from "./ultilizacaoVps";
import braipRoutes from "./BraipRoutes";
...
routes.use(internalMessageRouter);
routes.use(groupRoutes);
routes.use(braipRoutes);
