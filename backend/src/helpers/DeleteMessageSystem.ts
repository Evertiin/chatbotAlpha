...
import GetWbotMessage from "./GetWbotMessageBaileys";
...
const DeleteMessageSystem = async (
  ...
  if (ticket.channel === "whatsapp") {
    ...
    const messageDelete: WAMessage = JSON.parse(
      message.dataJson
    );
    await wbot.sendMessage(messageDelete.key.remoteJid!, { delete: messageDelete.key });
  }
