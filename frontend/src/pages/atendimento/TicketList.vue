<template>
  <div>
    <q-scroll-area ref="scrollAreaTickets" style="height: calc(100vh - 300px)" @scroll="onScroll">
      <!-- <q-separator /> -->
      <ItemTicket v-for="(ticket, key) in cTickets" :key="key" :ticket="ticket" :filas="filas" />
      <div v-if="loading">
