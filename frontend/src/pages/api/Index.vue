<template>
  <div>
      ...
      <q-card-section>
        <div class="text-h6">
          ...
          <q-btn-dropdown class="float-right" color="primary" label="Adcionar Integração">
            <q-list>
              <q-item clickable v-close-popup @click="apiEdicao = {}; modalApi = !modalApi;">
                <q-item-section avatar>
                  <q-img src="../integrations/logo/webhook.png" style="width: 100%;" />
                </q-item-section>
                <q-item-section>
              ...
              <q-item clickable @click="openModal">
                <q-item-section avatar>
                  <q-img src="../integrations/logo/braip.svg" />
                </q-item-section>
                <q-item-section>
                  <q-item-label>Braip</q-item-label>
                </q-item-section>
              </q-item>
               <!-- <q-item clickable v-close-popup @click="apiEdicaoISPFY = {}; modalApiISPFY = !modalApiISPFY;">
                <q-item-section avatar>
                  <q-img src="../integrations/logo/ispfy.png" />
                </q-item-section>
                <q-item-section>
                  <q-item-label>ISPFY</q-item-label>
                </q-item-section>
              </q-item> -->
            </q-list>
          </q-btn-dropdown>
          ...
          <q-item-section top>
            <q-item-label class="text-bold text-h6 q-my-sm">
              ...
              <div class="text-grey-8 q-gutter-xs float-right">
                <q-btn class="gt-xs" size="12px" flat dense round icon="mdi-content-copy" @click="copy(api.token)">
                  <q-tooltip>
                    Copiar token
                  </q-tooltip>
                </q-btn>
                <q-btn class="gt-xs" size="12px" flat dense round icon="edit" @click="editarAPI(api)">
                  <q-tooltip>
                    Editar Configuraçao
                  </q-tooltip>
                </q-btn>
                <q-btn class="gt-xs" size="12px" flat dense round icon="mdi-autorenew" @click="gerarNovoToken(api)">
                  <q-tooltip>
                    Gerar novo Token
                  </q-tooltip>
                </q-btn>

                <q-btn class="gt-xs" size="12px" flat dense round icon="delete" @click="deletarApi(api)">
                  <q-tooltip>
    ...
    <ModalApi :modalApi.sync="modalApi" :apiEdicao.sync="apiEdicao" @modal-api:criada="apiCriada"
...
import ModalBraip from './Modalbraip.vue'
export default {
  name: 'APIs',
  components: {
    ModalApi,
  ...
  data() {
    return {
      apiEdicao: {},
      modalApi: false,
      modalbraip: false, // Certifique-se de que a propriedade modalbraip esteja definida corretamente
      braipConfig: {},
      apis: [],
      pagination: {
        rowsPerPage: 40,
